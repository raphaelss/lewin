...
public class InterfaceGrafica extends javax.swing.JFrame {
    ...
    private void botaoGerarMatrizDodecafonicaActionPerformed(java.awt.event.ActionEvent evt) {
        limpaMatriz();
    ...
    private void botaoGerarFormaPrimaStrausActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoGerarFormaNormalStrausActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoGerarRotacaoStravinskyanaActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoMultiplicacaoBoulezActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoMultiplicacaoRahnActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoMultiplicacaoRahnEstendidoActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoGerarTabelaAdicaoActionPerformed(java.awt.event.ActionEvent evt) {
        limpaMatriz();
    ...
    private void botaoGerarVetorIntervalarActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoGerarSimilaridadeActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoGerarSubconjuntosActionPerformed(java.awt.event.ActionEvent evt) {
        int tamanho;
        try {
    ...
    private void botaoAlternarNumeroNotasItemStateChanged(java.awt.event.ItemEvent evt) {
    ...
    private void botaoInserirSegundoFatorItemStateChanged(java.awt.event.ItemEvent evt) {
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            for (JButton botao : botoesEntrada) {
    ...
    private void botaoReproduzirActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoPaletaActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoGerarFormaPrimaForteActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void botaoGerarFormaNormalForteActionPerformed(java.awt.event.ActionEvent evt) {
